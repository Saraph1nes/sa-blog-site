...
const Footer = () => {
  ...
  return <>
    ...
    {
      ctx.isMobile && ['/', '/category', '/about'].includes(pathname) && <Paper
        elevation={12}
        className='mobile-footer-wrap'
      >
        <BottomNavigation
          showLabels
          value={pathname}
        ...
        >
          <BottomNavigationAction value='/' label="首页" icon={<HomeIcon />} />
          <BottomNavigationAction value='/category' label="分类" icon={<CategoryIcon />} />
          <BottomNavigationAction value='/about' label="介绍" icon={<Person4Icon />} />
        </BottomNavigation>
      </Paper>
    }
