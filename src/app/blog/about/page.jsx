...
import {
  OPEN_SOURCE_PROJECT,
  PROJECT_LIST_DATA,
} from '@/app/blog/about/constant.js'
import ProjectList from '@/app/blog/about/ProjectList.jsx'
  ...
  return (
    <div className="about-page">
      <div className="about-page-left">
        ...
        />
        <div className="name">Saraph1nes</div>
        ...
        <div className="social-media">
          <ul className="social-media-nav">
            <IconButton
              aria-label="wechat"
              onClick={() => onSocialMediaNavClick(0)}
            >
              <img
                width={20}
            ...
            <IconButton
              aria-label="gmail"
              onClick={() => onSocialMediaNavClick(1)}
            >
              <img
                width={20}
                className="social-media-icon"
            ...
            <IconButton
              aria-label="juejin"
              onClick={() => onSocialMediaNavClick(2)}
            >
              <img
                width={20}
                className="social-media-icon"
            ...
            <IconButton
              aria-label="github"
              onClick={() => onSocialMediaNavClick(3)}
            >
              <GitHubIcon />
            </IconButton>
          </ul>
          <div className="social-media-content">
            ...
            {mediaSelectIndex === 2 && (
              <Button
                className="my-juejin"
                variant="outlined"
                href={'https://juejin.cn/user/2875978150062215/posts'}
                target="_blank"
              >
                <span>我的掘金</span>
      ...
      <div className="about-page-right">
        <div className="about-page-right-article">
          <section>
            ...
            <p>你好！我是Saraph1nes</p>
            <p>我喜欢编程、运动、音乐、摄影</p>
            <p>写博客是为了让自己有持续学习的动力</p>
            <p>希望能遇到更多志同道合的朋友，也希望更多的人能喜欢上我的博客</p>
          </section>
                  ...
                  <StepLabel
                    ...
                    optional={
                      <Typography variant="caption">
                        ...
                        <Link
                          to="https://saraph1nes.github.io/"
                          target="_blank"
                        >
                          https://saraph1nes.github.io/
                        </Link>
                      </Typography>
                    }
                  >
                  ...
                  <StepLabel
                    ...
                    optional={
                      <Typography variant="caption">
                        ...
                        <Link to="https://saraph1nes.gitee.io/" target="_blank">
                          https://saraph1nes.gitee.io/
                        </Link>
                      </Typography>
                    }
                  >
