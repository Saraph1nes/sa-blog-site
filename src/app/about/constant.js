...
export const OPEN_SOURCE_PROJECT = [
  {
    img: 'https://assest.sablogs.cn/imgs/blog/taro-ui-img.jpg',
    name: 'taro ui',
    desc: '一款基于 Taro 框架开发的多端 UI 组件库',
    githubLink: 'https://github.com/NervJS/taro/issues',
    microsoftLink: '',
    outerLink: 'https://taro-ui.taro.zone/#/'
  },
  {
    img: 'https://assest.sablogs.cn/imgs/blog/mdn-img.jpg',
    name: 'mdn content',
    desc: 'MDN中文文档',
    githubLink: 'https://github.com/mdn/',
    microsoftLink: '',
    outerLink: 'https://developer.mozilla.org/zh-CN/'
  },
]
